...
const sections = [
  ...
  },
  {
    ...
    body: [
      "가장 효과가 빠른 세 가지에 집중했습니다. ① 재고·수요 관리, ② AI 제품추천·견적, ③ 기존 고객 재구매 예측입니다.",
      "세 기능 모두 \"화면을 보는 순간 다음에 할 일이 보이는 것\"을 목표로 만들었습니다. 발주가 필요한 품목, 오늘 연락할 고객이 바로 보입니다.",
      "마진 가드, 설치장비 관리, 리포트 센터 등은 다음 단계 고도화 항목으로 목차만 열어 두었습니다.",
    ],
  },
  {
    icon: Workflow,
    ...
    title: "업무는 이렇게 달라집니다",
    body: [
      "아침에 대시보드를 열면 재고 상태, 이번 주 연락할 고객, 발주 신호가 한 화면에 정리되어 있습니다.",
      "고객 문의가 오면 조건 몇 가지를 고르는 것만으로 추천 장비와 견적 초안이 나옵니다. 견적 품질이 담당자에 따라 흔들리지 않습니다.",
      "고객이 연락하기 전에 우리가 먼저 제안하는 영업이 가능해집니다.",
    ],
  },
  {
    icon: TrendingUp,
    ...
    body: [
      ...
      "재구매 예측은 새 고객을 찾는 비용 없이 매출을 올리는 방법입니다. 기존 고객 유지 비용은 신규 고객 확보 비용보다 훨씬 낮습니다.",
      "추천·견적 자동화는 소모품·액세서리 동반 판매를 늘려 건당 매출을 키웁니다.",
    ],
  },
  {
    icon: Award,
  ...
  },
  {
    ...
    body: [
      ...
      "쌓이는 운영 데이터는 이후 지원사업의 성과 근거 자료로도 활용할 수 있습니다.",
    ],
  },
  {
    icon: Rocket,
    ...
    title: "앞으로",
    body: [
      "1단계(현재)는 mock 데이터 기반의 데모입니다. 화면과 업무 흐름을 확정하는 단계입니다.",
      "2단계에서 실제 판매·재고 데이터를 연결하고, 3단계에서 마진 가드·설치장비 관리·리포트 센터로 확장합니다.",
