...
const slides: Slide[] = [
  ...
  },
  {
    ...
    icon: Rocket,
    title: "앞으로 어디까지",
    lead: "지금 쌓이는 장비·요청 데이터 위에서 다음 사업이 열립니다.",
    points: [
      "1단계 효율화형 — 재고·견적·재구매·마진·교정 (현재 운영 중)",
      "2단계 사업모델 전환형 — 소모품 정기 배송, 연간 관리 계약, 성적서 발급, 계측기 단기 임대 (준비 중)",
      "3단계 산업전환형 — 원격 계측·데이터 리포트·예지보전·계측 대행 (실증 후 판단)",
      "각 항목이 어떤 데이터 위에서 어떻게 매출이 되는지, 무엇이 더 필요한지까지 고객 화면에 정리해 두었습니다.",
    ],
    route: { href: "/customer/services", label: "서비스 확장 로드맵 열기" },
    tone: "gold",
  },
];
